...
class TestCharacterData:
    ...
    def test_reshape_char_scalar_to_vector(self) -> None:
        ...
        assert result.shape == [5]
        assert _flat_chars(result) == "XXXXX"
    ...
    def test_reshape_empty_char_to_empty(self) -> None:
        # 0⍴'' is the degenerate case — empty source, empty target. Must
        # still be character data, not numeric.
        from marple.backend_functions import is_char_array
    ...
    def test_reshape_char_to_rank3(self) -> None:
        ...
        assert _flat_chars(result) == "ABCDEFGHIJKL"
    ...
    def test_reshape_char_cycles_when_target_larger(self) -> None:
        ...
        assert _flat_chars(result) == "ABABABA"
