"""PicoTimer — Timer adapter using MicroPython's time module.

Only loadable on MicroPython: the `ticks_ms` / `ticks_diff` attributes
used for elapsed-ms and sleep diagnostics are MicroPython-only.
"""
